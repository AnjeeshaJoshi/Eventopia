...
class _RegisterOrgSheetState extends State<RegisterOrgSheet> {
  ...
  Future<void> _submit() async {
    ...
    final err = context.read<AppProvider>().register(
      ...
      password: 'Org@1234', // default; organiser must change on first login
      role: UserRole.organizer,
      organization: _org.text.trim().isEmpty ? null : _org.text.trim(),
    );

    if (!mounted) return;
    setState(() { _loading = false; if (err != null) _error = err; else _done = true; });
  }
    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, sc) => Container(
        ...
        child: _done
          ...
          subtitle:
          'They will receive login credentials (default password: Org@1234).',
          btnLabel: 'Done',
          ...
          child: ListView(
            ...
            children: [
              ...
              const Text(
                  'A default password (Org@1234) will be assigned. They must change it on first login.',
